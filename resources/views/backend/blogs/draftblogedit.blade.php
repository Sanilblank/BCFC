...
@section('content')
    <div class="right_col" role="main">
        ...
        @endif
        <h1 class="mt-3">Edit Draft <a href="{{ route('draftblog.index') }}" class="btn btn-primary btn-sm"> <i
                    class="fa fa-eye" aria-hidden="true"></i> View Drafts</a></h1>
                            <div class="card mt-3">
                                <form action="{{route('draftblog.update', $blog->id)}}" method="POST" class="bg-light p-3" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="smalldesc" class="form-control" cols="20" rows="3" placeholder="Something to give info about the post">{{$blog->smalldesc}}</textarea>
                                                @error('smalldesc')
                                                    <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
