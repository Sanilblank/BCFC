                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p><b>Category:</b> {{$tags}}</p>
                                    <p><b>Date:</b> {{date('Y/m/d h:m a', strtotime($blog->date))}}</p>
                                    <p><b>Author:</b> {{$blog->authorname}}</p>
                                    <p><b>View Count:</b> {{$blog->view_count}}</p>
                                    <p><b>Status:</b> {{$blog->status == 1 ? 'Active' : 'Not Active'}}</p>

                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <img src="{{Storage::disk('uploads')->url($blog->image)}}" alt="{{$blog->title}}" style="max-height: 240px; max-width: 350px;">
                        </div>
                    </div>
                    <br>
                    <div class="row">
