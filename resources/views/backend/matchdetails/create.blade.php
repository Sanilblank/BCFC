...
@section('content')
    <div class="right_col" role="main">
        ...
        @endif
        <h1 class="mt-3">Create New Match <a href="{{ route('match.index') }}" class="btn btn-primary btn-sm"> <i
                    class="fa fa-eye" aria-hidden="true"></i> View All Upcoming Matches</a></h1>
                            <div class="card mt-3">
                                <form action="{{route('match.store')}}" method="POST" class="bg-light p-3" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" name="datetime" class="form-control" value="{{@old('datetime')}}" placeholder="Enter Date">
                                                @error('datetime')
                                                    <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
